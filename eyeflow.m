...
methods (Access = private)
    ...
    function createFileSelectionPanel(app)
        ...
        app.FolderManagementButton.Layout.Column = 3;
        ...
        app.ReferenceDirectory.Layout.Column = [1 3];
        ...
        app.EditMasksButton = uibutton(grid, 'push', ...
            ...
            'FontColor', [1 1 1], ...
            'Enable', 'off', ...
            'Visible', 'off', ... % Temporarly disabled
    ...
    function createProcessingOptionsPanel(app)
        ...
        app.pulseVelocityCheckBox = uicheckbox(grid, ...
            'Visible', 'off', 'Value', false, ... % Temporarly disabled
            'Text', 'Pulse Analysis', ...
            'Value', false, ...
            'FontColor', [1 1 1], ...
        ...
        app.exportCrossSectionResultsCheckBox = uicheckbox(grid, ...
            ...
            'ValueChangedFcn', @(~, ~) app.CheckboxValueChanged());
        app.exportCrossSectionResultsCheckBox.Layout.Row = 4;
        app.exportCrossSectionResultsCheckBox.Layout.Column = 1;
